...
import './menu1388.css'
import { coverContent, dishPages } from './data/menu1388-content'
import { imageMap, pageSize } from './data/menu1388'
...
const Menu1388Page = () => {
  ...
  return (
    <div className="menu1388" ref={menuRef}>
